            ...
            <form action="/register" method="post">
              ...
              <div class="form-floating">
                <input type="text" name="name" class="form-control rounded-top @error('name')is-invalid @enderror" id="name"
                 placeholder="what is your name.." required value={{ old('name') }}>
              ...
              <div class="form-floating">
                <input type="text" name="username" class="form-control @error('username')is-invalid @enderror" id="username"
                 placeholder="what is your username.." required value={{ old('username') }}>
              ...
              <div class="form-floating">
                <input type="email" name="email" class="form-control @error('email')is-invalid @enderror" id="email"
                 placeholder="what is your email.." required value={{ old('email') }}>
              ...
              <div class="form-floating">
                <input type="password" name="password" class="form-control @error('password')is-invalid @enderror" id="password"
                 placeholder="what is your password.." required value={{ old('password') }}>
